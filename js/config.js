...
const ENEMY_TYPES = [
  { name: 'Ghoul', sprite: 'ghoul', hp: 1, dmgMin: 1, dmgMax: 2, payout: 1.3, weight: 40 },
  { name: 'Skull', sprite: 'skull', hp: 2, dmgMin: 1, dmgMax: 2, payout: 2.0, weight: 30 },
  { name: 'Mage',  sprite: 'mage',  hp: 3, dmgMin: 1, dmgMax: 2, payout: 2.9, weight: 20 },
  { name: 'King',  sprite: 'king',  hp: 4, dmgMin: 1, dmgMax: 2, payout: 4.5, weight: 10 },
];
